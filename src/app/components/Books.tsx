    ...
    <div className="bg-[#FFFBEF] text-[#39210C]">
      ...
      <div className="max-w-xl text-center lg:text-left">
        <div className="px-8 py-8">
          <h1 className="text-lg font-bold">Welcome to Ray&apos;s Bookshelf</h1>
          <p className="mt-4">
            Find your next great read by browsing the collection, preview each
            book, and subscribe to unlock the full experience.
          </p>
        </div>
      </div>
            ...
            {currentlyReading.map((book:any) => (
              ...
              >
                ...
                <div className="h-16 space-y-1 w-full">
                  ...
                  <p className="text-xs text-left line-clamp-1">Rachel Maina</p>
                </div>
